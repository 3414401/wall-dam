...
export function WallCreateSurvey() {
  ...
  return (
    ...
    >
      ...
      <div className="card roster-upload-block">

        <h2 className="section-title">영구 명단 엑셀 (500명)</h2>

        <p className="api-banner-detail">

          조장이 매번 올리지 않습니다. 관리자가 GitHub에 올려 둔{" "}

          <strong>한 개의 엑셀</strong>을 모든 수업·코드가 공유합니다.

        </p>

        <p className="api-banner-detail" style={{ wordBreak: "break-all" }}>

          파일 위치:{" "}

          <a

            href="https://github.com/3414401/wall-dam/blob/main/data/roster.xlsx"
          ...
          >
            ...
            github.com/3414401/wall-dam → data/roster.xlsx
        ...
        <p className="api-banner-detail">
          ...
          (또는 <strong>data/roster.csv</strong>) · 1행=열이름 · 이름 열 권장
